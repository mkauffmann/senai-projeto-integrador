      ...
      <div class="container my-5">
        <div class="row">
          ...
          <div class="col-md-6 d-none d-md-block">
            <img src="@/assets/images/estudante-2.jpg" alt="Estudante segurando livros" class="img-fluid foto">
          </div>
        </div>
      </div>
    </section>
        ...
        <form id="form-cadastro" @submit.prevent="cadastrar">
          ...
          <div class="row mb-4">
            <div class="col-12 col-md-6 mb-3">
              <label for="nome" class="form-label">Nome<span class="campo-obrigatorio">*</span></label>
              <input 
                type="text" 
                name="nome" 
                id="nome" 
          ...
          <div class="row mb-4">
            <div class="col-12 col-md-6 mb-3">
              ...
              >
              <div class="form-text text-danger" v-if="erros.telefone">Telefone inválido</div>
            </div>
            <div class="col-12 col-md-6 mb-3">
              <label for="celular" class="form-label">Celular<span class="campo-obrigatorio">*</span></label>
              <input 
                type="text" 
                name="celular" 
                id="celular" 
          ...
          <div class="row mb-4">
            <div class="col-6 col-md-4 mb-3">
              <label for="cep" class="form-label">CEP<span class="campo-obrigatorio">*</span></label>
              <input 
                type="text" 
                name="cep" 
                id="cep" 
                ...
                required
              >
              <div class="form-text text-danger" v-if="erros.cep">CEP inválido, digite 8 números</div>
            </div>
            ...
            <div class="col-3 mb-3">
              <label for="numero" class="form-label">Numero<span class="campo-obrigatorio">*</span></label>
              <input 
                type="text" 
                name="numero" 
                id="numero" 
          ...
          <div class="row mb-4">
            <div class="col-12 col-md-6 mb-3">
              <label for="senha" class="form-label">Crie uma senha<span class="campo-obrigatorio">*</span></label>
              <input 
                type="password" 
                name="senha" 
                id="senha" 
            ...
            <div class="col-12 col-md-6 mb-3">
              <label for="senha-confirmar" class="form-label">Confirme sua senha<span class="campo-obrigatorio">*</span></label>
              <input 
                type="password" 
                ...
                required
              >
              <div class="form-text text-danger" v-if="erros.senha">As senhas não conferem</div>
            </div>
          </div>
          <div class="row justify-content-end">
            <button type="reset" class="botao-secundario col-4 col-md-2" @click="limparFormulario">Limpar</button>
            <button type="button" class="botao-secundario col-4 col-md-2" @click="validarFormulario">Validar</button>
            <button 
              type="submit" 
...
import { validaNome, validaCpf, validaTelefone, validaCelular, validaSenha, buscaCep } from '@/utils/formValidator';
